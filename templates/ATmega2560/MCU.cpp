...
/**
 * Настройка таймера/счётчика 3
 */
void CMCU::Timer3Init(){

}


/**
 * Настройка таймера/счётчика 4
 */
void CMCU::Timer4Init(){

}


/**
 * Настройка таймера/счётчика 5
 */
void CMCU::Timer5Init(){
...
/**
 * Настройка внутреннего USART1
 */
void CMCU::USART1Init() {

}


/**
 * Настройка внутреннего USART2
 */
void CMCU::USART2Init() {

}


/**
 * Настройка внутреннего USART3
 */
void CMCU::USART3Init() {
 ...
 */
void CMCU::OnTimerCounter4CaptureEvent(){
 ...
 */
void CMCU::OnTimerCounter4CompareMatchA(){
 ...
 */
void CMCU::OnTimerCounter4CompareMatchB(){
 ...
 */
void CMCU::OnTimerCounter4CompareMatchC(){
 ...
 */
void CMCU::OnTimerCounter4Overflow(){
 ...
 */
void CMCU::OnTimerCounter5CaptureEvent(){
 ...
 */
void CMCU::OnTimerCounter5CompareMatchA(){
 ...
 */
void CMCU::OnTimerCounter5CompareMatchB(){
 ...
 */
void CMCU::OnTimerCounter5CompareMatchC(){
 ...
 */
void CMCU::OnTimerCounter5Overflow(){
 ...
 * USART2 Rx Complete
 */
void CMCU::OnUSART2RxComplete( uint8_t data ){
 ...
 */
void CMCU::OnUSART2DataRegisterEmpty(){
 ...
 * USART3 Rx Complete
 */
void CMCU::OnUSART3RxComplete( uint8_t data ){
 ...
 */
void CMCU::OnUSART3DataRegisterEmpty(){
