...
//  Created on:      9 октября 2013 г. 15:55:12
...
public:
    ...
    inline static uint32_t GetBuild() { return 5030; }
    inline static uint32_t GetRevision() { return 28656; }

    inline static FCHAR_PTR GetVersionString() {
        return SPSTR( "0.1.5030.28656" );
    }
    inline static FCHAR_PTR GetBuildDateString() {
        return SPSTR( "9 октября 2013 г." );
    }
