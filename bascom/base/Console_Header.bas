...
Dim CData(11) As Byte
Dim CCommand As String * 10 At CData Overlay
...
' Псевдодекларация.
'Macro Console_CursorOn
'Macro Console_CursorOff
'Macro Console_SaveCursor
'Macro Console_RestoreCursor
...
Declare Sub Console_WriteFlashString( ByVal APtr As Word, ByVal ACodePage As Byte )
