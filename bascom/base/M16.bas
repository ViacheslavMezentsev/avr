...
'$include "M16_Header.bas"


'/**
' * Главный (основной) поток программы
' */
Sub M16_MainThreadProcedure
...
' */
Sub M16_ExternalInterruptsInit
