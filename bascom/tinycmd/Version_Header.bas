...
' Создан: 15 февраля 2015 г. 19:09:50
' Автор: Мезенцев В. Н.
'
...
Function Version_GetRevision() As DWORD : Version_GetRevision = 34495 : End Function
Function Version_GetVersionString() As String : Version_GetVersionString = "0.1.5524.34495" : End Function
