...
' Создан: 15 февраля 2015 г. 14:51:29
' Автор: Мезенцев В. Н.
'
...
Function Version_GetRevision() As DWORD : Version_GetRevision = 26744 : End Function
Function Version_GetVersionString() As String : Version_GetVersionString = "0.1.5524.26744" : End Function
