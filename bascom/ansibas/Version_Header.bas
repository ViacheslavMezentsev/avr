...
' Создан: 15 февраля 2015 г. 19:01:34
' Автор: Мезенцев В. Н.
'
...
Function Version_GetRevision() As DWORD : Version_GetRevision = 34247 : End Function
Function Version_GetVersionString() As String : Version_GetVersionString = "0.1.5524.34247" : End Function
