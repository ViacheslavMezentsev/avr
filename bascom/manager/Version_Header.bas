...
' Создан: 15 февраля 2015 г. 11:47:16
' Автор: Мезенцев В. Н.
'
...
Function Version_GetRevision() As DWORD : Version_GetRevision = 21218 : End Function
Function Version_GetVersionString() As String : Version_GetVersionString = "0.1.5524.21218" : End Function
